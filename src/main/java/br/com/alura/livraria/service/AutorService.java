...
public class AutorService {
	...
	@Transactional
	public AutorDto atualizar(AtualizacaoAutorFormDto dtoAtualizacao) {		
		Autor autor = autorRepository.getById(dtoAtualizacao.getId());
		autor.atualizarInformacoes(dtoAtualizacao.getNome(),dtoAtualizacao.getEmail(),dtoAtualizacao.getDataNascimento(),dtoAtualizacao.getMiniCurriculo());
